...
const MOCK_STATEMENTS: MockStatement[] = [
  { addrIndex: 0, forum: "us", content: "Access to high-quality medical care is a human right." },
  { addrIndex: 2, forum: "us", content: "We need to consider and prevent the potential downsides of AI." },
  { addrIndex: 0, forum: "us", content: "Loneliness is an epidemic. Touch grass, find a friend." },
  { addrIndex: 2, forum: "us", content: "We're better together." },
  { addrIndex: 0, forum: "us", content: "I want something to believe in." },
  { addrIndex: 0, forum: "us", content: "Nothing heals like a good chocolate chip cookie!" },
  { addrIndex: 2, forum: "us", content: "We're in the longest government shutdown in our history." },
  { addrIndex: 0, forum: "us", content: "All work and now play makes Hannah and sad girl" },
  { addrIndex: 2, forum: "us", content: "We should continue providing SNAP benefits despite the government shutdown" },
  { addrIndex: 0, forum: "us", content: "There should be a minimum of 4 weeks PTO for primary care givers." },
  { addrIndex: 0, forum: "global", content: "Gazan's deserve to not starve." },
  { addrIndex: 1, forum: "global", content: "Cooperation and peace > arms races and mistrust" },
...
export default buildModule("ForumMockedRegistryModule", (m) => {
  ...
  MOCK_STATEMENTS.forEach((stmt, idx) => {
    ...
    m.call(
      ...
      "addStatement",
      [stmt.content],
      { id: `addMockStatement${idx}`, from: fromAddress }
    );
  });
